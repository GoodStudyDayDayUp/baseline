			...
			<div class="controls">
				<div class="span2">
					<button type="button"
						...
						onclick="window.location.href='ProductServlet'">
						<i></i>言情
					</button>
				</div>
				<div class="span2">
					<button type="button"
						class="btn btn-icon btn-primary glyphicons circle_ok"
						onclick="window.location.href='CartServlet'">
						<i></i>历史
					</button>
				</div>
				<div class="span2">
					<button type="button"
						class="btn btn-icon btn-primary glyphicons circle_ok"
						onclick="window.location.href='BoughtServlet'">
						<i></i>科幻
					</button>
				</div>
				<div class="span2">
					<button type="button"
						class="btn btn-icon btn-primary glyphicons circle_ok"
						onclick="window.location.href='UserInfoServlet'">
						<i></i>谴责
					</button>
				</div>
				<div class="span2">
