...
.singleClass{
text-align:center;position:relative;height:64px; padding: 10px 0;  margin-left:15px; margin-right:15px;
	...
	<div class="container">
		...
		<div id="categoryShow" >			
			<div><div class="panel panel-default">
				<div class="panel-heading">	<h3 class="panel-title"> 一级分类  </h3></div>
			</div>
			<div class="row" style="margin-bottom:15px">
				<div class="col-lg-2 singleClass" > 
					<a href="javascript:;" class="1lClass" style="font-size:20px;" >小说</a>
				</div>
				<div class="col-lg-2 singleClass" > 
					<a href="javascript:;" class="1lClass" style="font-size:20px;" >小说</a>
				</div>
			...
			<div class="panel panel-default">
				<div class="panel-heading">	<h3 class="panel-title"> 二级分类  </h3> </div>
			</div>
			<div class="row" style="margin-bottom:15px">
					<div class="col-lg-2 singleClass" > 
					<a href="javascript:;" class="1lClass" style="font-size:20px;" >小说</a>
			...
			return true;
					...
					// 添加一级分类
						$(document).on("click","#add1lCategoryFunc",function(){
									...
									$(this).parent().html('<input type="text" style="border-top:none;border-left:none; border-right:none; outline:none;" size="10"  id="newClass" placeholder="新分类"/>'+
