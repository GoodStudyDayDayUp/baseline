				...
				<form name="newcase" id="newcase_id" method="post" action="">
					...
					<div class="row-fluid">
						<div class="control-group">
							...
							<div class="controls">
								<input type="text" name="name" id="name" value=""  readOnly="readonly" class="span12">
							</div>
						</div>
					</div>
					<div class="row-fluid">
						<div class="control-group">
							<label for="sex" class="control-label">密码</label>
							<div class="controls">
								<input type="password" name="pwd" id="pwd" value=""   class="span12">
							</div>
						</div>
					</div>
					<div class="row-fluid">
						<div class="control-group">
							<label for="sex" class="control-label">重置密码</label>
							<div class="controls">
								<input type="password" name="pwd" id="pwd" value=""   class="span12">
							</div>
						</div>
					...
					<div class="controls">
						<div class="span5">
							...
							<div class="span5">
							<button onclick="window.location.href='changePass.jsp'"
								class="btn btn-icon btn-primary glyphicons circle_ok">
								<i></i>重     置
							</button>
						</div>
