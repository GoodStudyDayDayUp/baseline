				...
				<div class="panel panel-default">
					...
					<ul class="list-group">
						<li class="list-group-item"">
							...
							</table> <%}else{ %> <%for(int i=0;i<i2uDArray.length;i++){ %>
							<table>
								<tr>
									<td style="width: 100px;"><a
										href="viewPerson.action?name=<%=i2uDArray[i][1]%>"><b><%=i2uDArray[i][1] %></b></a></td>
									<td><p
											style="font-size: 12px; padding-bottom: -10px; margin-bottom: -10px;">
											粉丝数：<span><%=i2uDArray[i][2] %></span>&nbsp;&nbsp;&nbsp;&nbsp;章节数：<span><%=i2uDArray[i][3] %></span>
										</p></td>
								</tr>
							</table> <a href=setAttention.action?id= <%=i2uDArray[i][0] %>><button
									class="btn btn-info" style="float: right; margin-top: -25px;">
									关注TA</button></a> <%} }%>
						</li>
					</ul>
				...
				<div class="panel panel-default">
					...
					<ul class="list-group">
						<li class="list-group-item"">
							...
							</table> <%}else{ %> <%for(int i=0;i<u2iDArray.length;i++){ %>
							<table>
								<tr>
									<td style="width: 100px;"><a
										href="viewPerson.action?name=<%=u2iDArray[i][1]%>"><b><%=u2iDArray[i][1] %></b></a></td>
									<td><p
											style="font-size: 12px; padding-bottom: -10px; margin-bottom: -10px;">
											粉丝数：<span><%=u2iDArray[i][2] %></span>&nbsp;&nbsp;&nbsp;&nbsp;章节数：<span><%=u2iDArray[i][3] %></span>
										</p></td>
								</tr>
							</table> <a href=setAttention.action?id= <%=u2iDArray[i][0] %>><button
									class="btn btn-info" style="float: right; margin-top: -25px;">
									关注TA</button></a> <%} }%>
						</li>
					</ul>
